...
preguntas[2]=new pregunta("¿Cómo se denota un lenguaje (P) escrito en lenguaje fuente (LF)?","LF/P","F/P","P/LF","P/L",3);
...
preguntas[38]=new pregunta("Si una función cuenta con un algoritmo que dada la entrada, se llega al valor de llegada correspondiente de dicha función. ¿Qué se puede afirmar?" , "que es una función no computable" , "que es solo un algritmo" , "que es una función computable" , "que no es una función" , 3 );
preguntas[39]=new pregunta("¿Cómo se define un formalismo?" , "la función de un sistema" , "el algoritmo de una función" , "un lenguaje de programación" , "la descripción de un sistema en el que se puede llevar a cabo unos cálculos" , 4 );
preguntas[40]=new pregunta("¿Qué quiere decir que cada instrucción de un algoritmo tiene un efecto limitado?" , "que no puede modificar el estado de algo fuera de su alcance" , "que depende de un número finito de pasos previos" , "que se escribe en una porción de espacio finito" , "no es una característica de un algoritmo" , 1 );
preguntas[41]=new pregunta("¿A qué se refiere la composición de Máquinas de Turing?" , "descripción de la computación en un momento dado" , "fusionar distintas funciones de transición" , "contenido de la cinta" , "posición de la cabeza en la cinta" , 2 );
preguntas[42]=new pregunta("¿Qué es una configuración en una Máquina de Turing?" , "descripción de la computación en un momento dado" , "fusionar distintas funciones de transición" , "contenido de la cinta" , "posición de la cabeza en la cinta" , 1 );
preguntas[43]=new pregunta("¿Qué nombre tienen designado las funciones calculables matemáticamente?" , "funciones no computables" , "no son funciones" , "funciones efectivamente calculables" , "funciones universales" , 3 );
preguntas[44]=new pregunta("¿Qué se usa para representar las funciones efectivamente calculables?" , "máquinas virtuales" , "lenguajes de programación" , "funciones universales" , "computadoras" , 2 );
preguntas[45]=new pregunta("¿Qué es una Máquina de Turing?" , "cinta infinita de casillas iguales" , "cinta infinita de casillas diferentes" , "cinta finita de casillas iguales" , "cinta finita de casillas diferentes" , 1 );
