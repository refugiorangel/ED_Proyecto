...
preguntas[18]=new pregunta("¿En cuantos modulos se divide la mayoria de los intérpretes?" , "2" , "3" , "4" , "5" , 3 );
...
preguntas[23]=new pregunta("¿Qué sucede dentro del módulo de tratamiento de errores?" , "Traducción del código" , "Evaluación para la prevención de errores" , "La información se almacena en una tabla" , "Análisis y trasformación del código" , 2 );
...
preguntas[25]=new pregunta("¿Cuál es la primera fase de la interpretación recursiva?" , "Construcción de interprete prototipo" , "Implementación del compilador" , "Análisis del código" , "Traducción del lenguaje" , 1 );
...
preguntas[27]=new pregunta("¿Cuántos tipos de interprete se mencionan?" , "6" , "3" , "1" , "5" , 1 );
...
preguntas[37]=new pregunta("Si una función cuenta con un algoritmo que dada la entrada, se llega al valor de llegada correspondiente de dicha función. ¿Qué se puede afirmar?" , "que es una función no computable" , "que es solo un algritmo" , "que es una función computable" , "que no es una función" , 3 );
